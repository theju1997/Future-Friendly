...
FOR %%x IN ("D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\php.exe"
GOTO :INSTALLED
