...
if ('D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\Apponix\Future-Friendly\Phy-Fullstack\Database\MySql\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
